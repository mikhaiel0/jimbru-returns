...
//media
const VoiceNoteJimbru = JSON.parse(fs.readFileSync('./JimbruMedia/database/jimbruvn.json'))
const JimbruSticker = JSON.parse(fs.readFileSync('./JimbruMedia/database/jimbrusticker.json'))
const JimbruImage = JSON.parse(fs.readFileSync('./JimbruMedia/database/jimbruimage.json'))
const JimbruVideo = JSON.parse(fs.readFileSync('./JimbruMedia/database/jimbruvideo.json'))
const JimbruDoc = JSON.parse(fs.readFileSync('./JimbruMedia/database/doc.json'))
const JimbruZip = JSON.parse(fs.readFileSync('./JimbruMedia/database/zip.json'))
const JimbruApk = JSON.parse(fs.readFileSync('./JimbruMedia/database/apk.json'))
...
module.exports = JimbruBot = async (JimbruBot, m, chatUpdate, store) => {
    try {
       ...
       //group
        ...
        let JimbruStickerReply = fs.readFileSync('./JimbruMedia/theme/sticker_reply/wait.webp')
        JimbruBot.sendMessage(from, { sticker: JimbruStickerReply }, { quoted: m })
        }
        const JimbruStickerAdmin = () => {
        let JimbruStickerReply = fs.readFileSync('./JimbruMedia/theme/sticker_reply/admin.webp')
        JimbruBot.sendMessage(from, { sticker: JimbruStickerReply }, { quoted: m })
        }
        const JimbruStickerBotAdmin = () => {
        let JimbruStickerReply = fs.readFileSync('./JimbruMedia/theme/sticker_reply/botadmin.webp')
        JimbruBot.sendMessage(from, { sticker: JimbruStickerReply }, { quoted: m })
        }
        const JimbruStickerOwner = () => {
        let JimbruStickerReply = fs.readFileSync('./JimbruMedia/theme/sticker_reply/owner.webp')
        JimbruBot.sendMessage(from, { sticker: JimbruStickerReply }, { quoted: m })
        }
        const JimbruStickerGroup = () => {
        let JimbruStickerReply = fs.readFileSync('./JimbruMedia/theme/sticker_reply/group.webp')
        JimbruBot.sendMessage(from, { sticker: JimbruStickerReply }, { quoted: m })
        }
        const JimbruStickerPrivate = () => {
        let JimbruStickerReply = fs.readFileSync('./JimbruMedia/theme/sticker_reply/private.webp')
        JimbruBot.sendMessage(from, { sticker: JimbruStickerReply }, { quoted: m })
        }
        //premium
    ...
    return await JimbruBot.relayMessage(chatId, generate.message, { messageId: generate.key.id })
                ...
                JimbruBot.sendMessage(m.chat, {
                    contextInfo: {
                        externalAdReply: {
                            ...
                            body: ownername,
                            previewType: "PHOTO",
                            thumbnail: fs.readFileSync('./JimbruMedia/theme/Jimbru.jpg'),
                            sourceUrl: wagc
                        }
                    },
                    text: teks
	    ...
	    const fakestatus = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {})},message: { "imageMessage": {"url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc","mimetype": "image/jpeg","caption": wm,"fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=","fileLength": "28777","height": 1080,"width": 1079,"mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=","fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=","directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69","mediaKeyTimestamp": "1610993486","jpegThumbnail": fs.readFileSync('./JimbruMedia/theme/Jimbru.jpg'),"scansSidecar": "1W0XhfaAcDwc7xh1R8lca6Qg/1bB4naFCSngM2LKO2NoP5RI7K+zLw=="}}}
	    const frpayment = {
	key: {
...
JimbruBot.sendMessage(`${ownernumber}@s.whatsapp.net`,{text: `Hi Owner! wa.me/${sender.split("@")[0]} Detected Having Sent Virtex ${isGroup?`in ${groupName}`:''}`})
 ...
 if (db.data.chats[m.chat].antibot) {
    ...
    return JimbruBot.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: false, id: m.key.id, participant: m.key.participant }})
        ...
        if (db.data.chats[m.chat].image && isJimbruMedia) {
    if(isJimbruMedia === "imageMessage"){
        if (JimbruByMikhaiel || isAdmins || !isBotAdmins){		  
        } else {
    ...
    return JimbruBot.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: false, id: m.key.id, participant: m.key.participant }})
        ...
        if (db.data.chats[m.chat].antivideo && isJimbruMedia) {
    if(isJimbruMedia === "videoMessage"){
        if (JimbruByMikhaiel || isAdmins || !isBotAdmins){		  
        } else {
    ...
    return JimbruBot.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: false, id: m.key.id, participant: m.key.participant }})
        ...
        if (db.data.chats[m.chat].antisticker && isJimbruMedia) {
    if(isJimbruMedia === "stickerMessage"){
        if (JimbruByMikhaiel || isAdmins || !isBotAdmins){		  
        } else {
    ...
    return JimbruBot.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: false, id: m.key.id, participant: m.key.participant }})
        ...
        if (db.data.chats[m.chat].antiaudio && isJimbruMedia) {
    if(isJimbruMedia === "audioMessage"){
        if (JimbruByMikhaiel || isAdmins || !isBotAdmins){		  
        } else {
    ...
    return JimbruBot.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: false, id: m.key.id, participant: m.key.participant }})
       ...
       if (db.data.chats[m.chat].antipoll && isJimbruMedia) {
    if(isJimbruMedia === "pollCreationMessage"){
        if (JimbruByMikhaiel || isAdmins || !isBotAdmins){		  
        } else {
    ...
    return JimbruBot.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: false, id: m.key.id, participant: m.key.participant }})
       ...
       if (db.data.chats[m.chat].antilocation && isJimbruMedia) {
    if(isJimbruMedia === "locationMessage"){
        if (JimbruByMikhaiel || isAdmins || !isBotAdmins){		  
        } else {
    ...
    return JimbruBot.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: false, id: m.key.id, participant: m.key.participant }})
       ...
       if (db.data.chats[m.chat].antidocument && isJimbruMedia) {
    if(isJimbruMedia === "documentMessage"){
        if (JimbruByMikhaiel || isAdmins || !isBotAdmins){		  
        } else {
    ...
    return JimbruBot.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: false, id: m.key.id, participant: m.key.participant }})
      ...
      if (db.data.chats[m.chat].anticontact && isJimbruMedia) {
    if(isJimbruMedia === "contactMessage"){
        if (JimbruByMikhaiel || isAdmins || !isBotAdmins){		  
        } else {
...
if (budy === BhoomJimbru) {
let buffer = fs.readFileSync(`./JimbruMedia/apk/${BhoomJimbru}.apk`)
sendapk(buffer)
}
}
...
if (budy === BhoomJimbru) {
let buffer = fs.readFileSync(`./JimbruMedia/zip/${BhoomJimbru}.zip`)
sendzip(buffer)
}
}
...
if (budy === BhoomJimbru) {
let buffer = fs.readFileSync(`./JimbruMedia/doc/${BhoomJimbru}.pdf`)
senddocu(buffer)
}
}
...
fs.writeFileSync('./src/data/role/user.json', JSON.stringify(jimbruverifieduser, null, 2))
        ...
        switch (isCommand) {
            ...
            case 'sim': {
                ...
                await fsx.copy(delb, './JimbruMedia/theme/Jimbru.jpg')
                fs.unlinkSync(delb)
                replygcjimbru(mess.done)
            }
            break
            ...
            case 'sgm': {
                if (!JimbruByMikhaiel) return JimbruStickerOwner()
                let delb = await JimbruBot.downloadAndSaveMediaMessage(quoted)
                await fsx.copy(delb, './JimbruMedia/theme/Jimbru-bot.mp4')
                fs.unlinkSync(delb)
                replygcjimbru(mess.done)
            }
            break
...
let delb = await JimbruBot.downloadAndSaveMediaMessage(quoted)
JimbruVideo.push(q)
await fsx.copy(delb, `./JimbruMedia/video/${q}.mp4`)
fs.writeFileSync('./JimbruMedia/database/jimbruvideo.json', JSON.stringify(JimbruVideo))
fs.unlinkSync(delb)
...
fs.writeFileSync('./JimbruMedia/database/jimbruvideo.json', JSON.stringify(JimbruVideo))
fs.unlinkSync(`./JimbruMedia/video/${q}.mp4`)
...
let delb = await JimbruBot.downloadAndSaveMediaMessage(quoted)
JimbruImage.push(q)
await fsx.copy(delb, `./JimbruMedia/image/${q}.jpg`)
fs.writeFileSync('./JimbruMedia/database/jimbruimage.json', JSON.stringify(JimbruImage))
fs.unlinkSync(delb)
...
fs.writeFileSync('./JimbruMedia/database/jimbruimage.json', JSON.stringify(JimbruImage))
fs.unlinkSync(`./JimbruMedia/image/${q}.jpg`)
...
await fsx.copy(delb, `./JimbruMedia/sticker/${q}.webp`)
fs.writeFileSync('./JimbruMedia/database/jimbrusticker.json', JSON.stringify(JimbruSticker))
fs.unlinkSync(delb)
...
fs.writeFileSync('./JimbruMedia/database/jimbrusticker.json', JSON.stringify(JimbruSticker))
fs.unlinkSync(`./JimbruMedia/sticker/${q}.webp`)
...
await fsx.copy(delb, `./JimbruMedia/audio/${q}.mp3`)
fs.writeFileSync('./JimbruMedia/database/jimbruvn.json', JSON.stringify(VoiceNoteJimbru))
fs.unlinkSync(delb)
...
fs.writeFileSync('./JimbruMedia/database/jimbruvn.json', JSON.stringify(VoiceNoteJimbru))
fs.unlinkSync(`./JimbruMedia/audio/${q}.mp3`)
...
let delb = await JimbruBot.downloadAndSaveMediaMessage(quoted)
JimbruZip.push(teks)
await fsx.copy(delb, `./JimbruMedia/zip/${teks}.zip`)
fs.writeFileSync('./JimbruMedia/database/zip.json', JSON.stringify(JimbruZip))
fs.unlinkSync(delb)
...
fs.writeFileSync('./JimbruMedia/database/zip.json', JSON.stringify(JimbruZip))
fs.unlinkSync(`./JimbruMedia/zip/${teks}.zip`)
...
let delb = await JimbruBot.downloadAndSaveMediaMessage(quoted)
apknye.push(teks)
await fsx.copy(delb, `./JimbruMedia/apk/${teks}.apk`)
fs.writeFileSync('./JimbruMedia/database/apk.json', JSON.stringify(JimbruApk))
fs.unlinkSync(delb)
...
fs.writeFileSync('./JimbruMedia/database/apk.json', JSON.stringify(JimbruApk))
fs.unlinkSync(`./JimbruMedia/apk/${teks}.apk`)
...
let delb = await JimbruBot.downloadAndSaveMediaMessage(quoted)
JimbruDoc.push(teks)
await fsx.copy(delb, `./JimbruMedia/doc/${teks}.pdf`)
fs.writeFileSync('./JimbruMedia/database/doc.json', JSON.stringify(JimbruDoc))
fs.unlinkSync(delb)
...
fs.writeFileSync('./JimbruMedia/database/doc.json', JSON.stringify(JimbruDoc))
fs.unlinkSync(`./JimbruMedia/doc/${teks}.pdf`)
...
case 'patrick':
case 'patricksticker': {
var ano = await fetchJson('https://raw.githubusercontent.com/Mikhaiel/JimbruMedia/main/patrick')
...
case 'dogestick':
	case 'doge':{
var ano = await fetchJson('https://raw.githubusercontent.com/Mikhaiel/JimbruMedia/main/doge')
var wifegerak = ano.split('\n')
var wifegerakx = wifegerak[Math.floor(Math.random() * wifegerak.length)]
encmedia = await JimbruBot.sendImageAsSticker(from, wifegerakx, m, { packname: global.packname, author: global.author, })
}
...
case 'lovesticker':
case 'lovestick' :{
var ano = await fetchJson('https://raw.githubusercontent.com/Mikhaiel/JimbruMedia/main/love')
var wifegerak = ano.split('\n')
var wifegerakx = wifegerak[Math.floor(Math.random() * wifegerak.length)]
encmedia = await JimbruBot.sendImageAsSticker(from, wifegerakx, m, { packname: global.packname, author: global.author, })
...
case 'gura':
case 'gurastick':{
var ano = await fetchJson('https://raw.githubusercontent.com/Mikhaiel/JimbruMedia/main/gura')
var wifegerak = ano.split('\n')
var wifegerakx = wifegerak[Math.floor(Math.random() * wifegerak.length)]
encmedia = await JimbruBot.sendImageAsSticker(from, wifegerakx, m, { packname: global.packname, author: global.author, })
...
if (typemenu === 'v1') {
                    JimbruBot.sendMessage(m.chat, {
                        image: fs.readFileSync('./JimbruMedia/theme/Jimbru.jpg'),
                        caption: xmenu_oh
                    }, {
                        quoted: m
                    })
                    ...
                    JimbruBot.sendMessage(m.chat, {
                        video: fs.readFileSync('./JimbruMedia/theme/Jimbru-bot.mp4'),
                        caption: xmenu_oh
                    }, {
                        quoted: m
                    })
